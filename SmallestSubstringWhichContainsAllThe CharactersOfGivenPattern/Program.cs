...
namespace SmallestSubstringWhichContainsAllThe_CharactersOfGivenPattern
{
    internal class Program
    {
        public void SmallestSubstringWhichContainsAllThe_CharactersOfGivenPattern(string pattern, string str)
        {
        ...
        static void Main(string[] args)
        {
            ...
            program.SmallestSubstringWhichContainsAllThe_CharactersOfGivenPattern("abcd", "bcdefcbabcbd");
        }
    }
}
